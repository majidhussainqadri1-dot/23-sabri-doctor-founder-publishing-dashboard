...
5. No production write action until the provider adapter reaches Production-Accepted maturity.
6. No client-supplied role, author, provider, or status is trusted.
7. No patient-identifying content may be stored in File 23-owned tables.
