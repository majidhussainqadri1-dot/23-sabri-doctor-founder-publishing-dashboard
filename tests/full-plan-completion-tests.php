...
$assert( str_contains( $main, "Version:     1.2.2" ) && str_contains( $main, "SPDB_VERSION', '1.2.2" ), 'Plugin release identity must be 1.2.2.' );
$assert( str_contains( $readme, 'Stable tag: 1.2.2' ), 'Readme stable tag must match 1.2.2.' );
