...
$gates = array(
	array( 'main', array( 'Version:     1.2.1', "SPDB_VERSION', '1.2.1" ) ),
	...
	array( 'build', array( 'version="1.2.1"', 'git archive', 'SOURCE-MANIFEST' ) ),
	array( 'workflow', array( 'forty-round-review-gate-tests.php', 'AUDIT-40-ROUND-REVIEW-AND-CORRECTIONS', 'file23-1.2.1' ) ),
);
