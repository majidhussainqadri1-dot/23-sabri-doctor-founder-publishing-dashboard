...
$tests  = 0;
$failed = 0;
function spdb_core_assert( bool $condition, string $message ): void { global $tests, $failed; ++$tests; if ( ! $condition ) { ++$failed; fwrite( STDERR, "FAIL: {$message}\n" ); } }
function spdb_core_error_code( $value ): string { return $value instanceof WP_Error ? $value->get_error_code() : ''; }
...
$normalized = SPDB_Saved_Views::normalize_definition( array( 'label' => 'Scheduled articles', 'filters' => array( 'status' => 'scheduled', 'provider' => 'file21', 'patient_id' => 'must-not-persist', 'unknown' => 'ignored', 'date_from' => '2026-07-01', 'direction' => 'desc' ) ) );
...
$GLOBALS['spdb_test_user_meta'][7]['spdb_saved_views_v1'] = array( array( 'id' => 'view_123e4567e89b12d3a456426614174000', 'label' => '<b>My view</b>', 'filters' => array( 'status' => 'draft', 'patient_id' => 'forbidden' ), 'created_at' => '2026-07-30 02:27:00', 'version' => 1 ) );
