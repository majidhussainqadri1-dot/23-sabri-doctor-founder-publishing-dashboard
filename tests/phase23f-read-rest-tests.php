...
final class SPDB_Test_Read_Repository implements SPDB_Collections_Repository {
	...
	public function list_collections( array $query ) { return array( 'items' => array( $this->collection ), 'page' => $query['page'], 'per_page' => $query['per_page'], 'total' => 1, 'has_more' => $this->bad_has_more ); }
