...
final class SPDB_Test_Workspace_Adapter implements SPDB_Provider_Adapter, SPDB_Workspace_Provider_Adapter {
	...
	public function __construct( array $config = array() ) {
		$this->config = array_merge( array(
			...
			'supported_capabilities' => array( 'spdb_view_own_content', 'spdb_manage_own_content' ),
	...
	public function get_supported_capabilities(): array { return (array) $this->config['supported_capabilities']; }
	...
	public function get_workspace_projection( array $context ) {
		...
		if ( ! empty( $this->config['throw_on_workspace'] ) ) { throw new RuntimeException( 'Synthetic workspace provider failure.' ); }
