...
$assert( str_contains( $capabilities, 'verified_session_capabilities' ) && str_contains( $capabilities, "'session_two_factor'" ), 'Privileged current-session MFA enforcement must remain.' );
...
/* Preserve historical evidence without freezing later companion revisions. */
$assert( str_contains( $audit, '4c5fa4946cca6d89e9d42e0df22659f222451398' ), 'The second-review audit must retain its historical File 22 exact pin.' );
...
$assert( str_contains( $workflow, 'FILE21_SHA: d00f60ce0ca4d1c9860d724a2beb57e3d03e5d5b' ), 'The current File 21 exact contract pin must remain explicit.' );
