...
final class SPDB_Module_Manifest {
	...
	private static function definitions(): array {
		return array(
			0  => self::definition( 'Sabri Membership Core', 'identity and authorization assertions', 'hard', 'file00', array( 'file00', 'membership' ) ),
			1  => self::definition( 'Platform Foundation and Governance', 'registry, contracts and change control', 'core', 'file01', array( 'file01', 'foundation' ) ),
			2  => self::definition( 'Authentication and Accounts', 'authenticated session entry', 'core', 'file00', array( 'file02', 'authentication' ) ),
			3  => self::definition( 'Profiles and Doctors', 'identity projection and native edit route', 'domain', 'file03', array( 'file03', 'profile' ) ),
			4  => self::definition( 'Legacy Publishing Adapter', 'migration diagnostics only', 'legacy', 'file21', array( 'file04', 'legacy' ) ),
			5  => self::definition( 'Learn Sabri Classical Homeopathy', 'learning publication projections', 'domain', 'file05', array( 'file05', 'learn' ) ),
			6  => self::definition( 'Homeopathy Encyclopedia', 'knowledge entries and corrections', 'domain', 'file06', array( 'file06', 'encyclopedia' ) ),
			7  => self::definition( 'Doctors Directory and Discovery', 'public doctor destination', 'domain', 'file07', array( 'file07', 'doctor_directory' ) ),
			8  => self::definition( 'Worldwide Clinic and Appointments', 'clinic and appointment context', 'domain', 'file08', array( 'file08', 'clinic', 'appointment' ) ),
			9  => self::definition( 'Doctor Onboarding and Verification', 'publishing eligibility projection', 'domain', 'file09', array( 'file09', 'verification' ) ),
